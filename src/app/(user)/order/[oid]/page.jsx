...
export const metadata = {
  title: 'Order Confirmation | Net to Plate - Your Order Has Been Successfully Placed',
  description:
    'Congratulations! Your order has been successfully placed on Net to Plate. Thank you for choosing us for your shopping needs. Expect fast processing and delivery. Stay tuned for updates on your order status. Shop more with Net to Plate!',
  applicationName: 'Net to Plate',
  authors: 'Net to Plate',
  keywords:
    'order confirmation, Net to Plate, order placed, successful order, order processing, order delivery, order status, order updates, fast delivery, shopping confirmation, shopping success, shopping updates, online shopping'
};
