...
export default function RegisterForm() {
  ...
  const RegisterSchema = Yup.object().shape({
    ...
    confirmpass: Yup.string().required('Confirm Password is required').min(8, 'Password should be 8 characters or longer.').oneOf([Yup.ref('password')], 'Passwords must match')
  });
    ...
    <FormikProvider value={formik}>
      <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
        ...
        <Typography variant="body2" align="center" color="text.secondary" mt={2}>
          By registering, I agree to Net to Plate&nbsp;
