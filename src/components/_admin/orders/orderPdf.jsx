      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>ttt-clothing</Text>
            <Text style={styles.body1}>LB Nagar, Hyderabad</Text>
            <Text style={styles.body1}>+123 4567 890</Text>
            <Text style={styles.body1}> info@ttt-clothing.com</Text>
          </View>
          <View style={styles.col6}>
        ...
        <View style={[styles.gridContainer, styles.footer]}>
          ...
          <View style={[styles.col4, styles.alignRight]}>
            ...
            <Text> info@ttt-clothing.com</Text>
          </View>
        </View>
      </Page>
    </Document>
